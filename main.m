...
dataFolder = '/Desktop/VR interface/Data';
codesFolder = '/Desktop/VR interface/Analysis Codes';
PrincipalComponents = [];
numUsers = 9;
trainingData = [];
...
writetable(PrincipalComponents,'/Desktop/PCA.csv')
...
writetable(trainingData,'/Desktop/trainingData.csv')
